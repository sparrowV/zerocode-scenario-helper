package ge.odvali.actions.soap;
...
public class SOAPAction extends AnAction {
    @Override
    ...
    private ObjectNode createPOSTTemplateStep() {
        ...
        headersTemplate.put("Content-Type", "text/xml; charset=utf-8");
        requestBodyTemplate.putIfAbsent("headers", headersTemplate);
        requestBodyTemplate.put("body", "");
